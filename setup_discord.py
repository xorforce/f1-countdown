...
***REMOVED***
ERROR_WEBHOOK_URL = "https://discord.com/api/webhooks/1393343102642684005/WJ4VLmQJlwKgV4gEFygYSDIMf-GdIJqsA5O4OhzPbpwrOoYC4alyMHTx-3H3_LPc0T_7"
SUCCESS_WEBHOOK_URL = "https://discord.com/api/webhooks/1393347157171507350/2hSms-MqF2_yzpnNhEbFJbFse6JP2-TpsTV0h0ywDGgAjUwaXa9iiwTVzroBQ_WgF4zC"
...
def setup_discord_webhooks():
    ...
    print("\nConfigured webhooks:")
    print(f"  • Error notifications → Incoming Failures channel")
    print(f"  • Success notifications → Incoming Tweets channel")
